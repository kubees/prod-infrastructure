resource "helm_release" "videos_microservice_release" {
  ...
  repository        = "https://gitlab.com/api/v4/projects/42388109/packages/helm/api/stable/charts"
...
resource "helm_release" "playlist_microservice_release" {
  ...
  repository        = "https://gitlab.com/api/v4/projects/42388143/packages/helm/api/stable/charts"
  version           = "v0.1.0"
  namespace         = var.microservices_ns
  create_namespace  = true
  dependency_update = true
